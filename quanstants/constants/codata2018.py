...
#conductance_quantum = Constant(None, "conductance_quantum", Quantity("7.748091729...e-5", u.S, 0), canon_symbol=False)
...
#Faraday_constant = Constant(None, "Faraday_constant", Quantity("96485.33212...", u.C * u.mol**-1, 0), canon_symbol=False)
...
#first_radiation_constant = Constant(None, "first_radiation_constant", Quantity("3.741771852...e-16", u.W * u.m**2, 0), canon_symbol=False)
#first_radiation_constant_for_spectral_radiance = Constant(None, "first_radiation_constant_for_spectral_radiance", Quantity("1.191042972...e-16", u.W * u.m**2 * u.sr**-1, 0), canon_symbol=False)
...
#Josephson_constant = Constant(None, "Josephson_constant", Quantity("483597.8484...e9", u.Hz * u.V**-1, 0), canon_symbol=False)
...
#Loschmidt_constant_27315_K_100_kPa = Constant(None, "Loschmidt_constant_27315_K_100_kPa", Quantity("2.651645804...e25", u.m**-3, 0), canon_symbol=False)
#Loschmidt_constant_27315_K_101325_kPa = Constant(None, "Loschmidt_constant_27315_K_101325_kPa", Quantity("2.686780111...e25", u.m**-3, 0), canon_symbol=False)
luminous_efficacy = fundamental.luminous_efficacy_540_THz
#mag_flux_quantum = Constant(None, "mag_flux_quantum", Quantity("2.067833848...e-15", u.Wb, 0), canon_symbol=False)
molar_gas_constant = Constant("R", "molar_gas_constant", Quantity("8.31446261815324", u.J * u.mol**-1 * u.K**-1, 0), canon_symbol=True, alt_names=["gas_constant"])
...
#reduced_Planck_constant = Constant(None, "reduced_Planck_constant", Quantity("1.054571817...e-34", u.J * u.s, 0), canon_symbol=False)
...
#second_radiation_constant = Constant(None, "second_radiation_constant", Quantity("1.438776877...e-2", u.m * u.K, 0), canon_symbol=False)
...
standard_acceleration_of_gravity = Constant(None, "standard_acceleration_of_gravity", Quantity("9.80665", u.m * u.s**-2, 0), canon_symbol=False)
#Stefan_Boltzmann_constant = Constant(None, "Stefan_Boltzmann_constant", Quantity("5.670374419...e-8", u.W * u.m**-2 * u.K**-4, 0), canon_symbol=False)
...
#von_Klitzing_constant = Constant(None, "von_Klitzing_constant", Quantity("25812.80745...", u.ohm, 0), canon_symbol=False)
weak_mixing_angle = Constant(None, "weak_mixing_angle", Quantity("0.22290", u.unitless, "0.00030"), canon_symbol=False)
#Wien_frequency_displacement_law_constant = Constant(None, "Wien_frequency_displacement_law_constant", Quantity("5.878925757...e10", u.Hz * u.K**-1, 0), canon_symbol=False)
#Wien_wavelength_displacement_law_constant = Constant(None, "Wien_wavelength_displacement_law_constant", Quantity("2.897771955...e-3", u.m * u.K, 0), canon_symbol=False)
