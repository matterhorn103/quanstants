...
permille = DerivedUnit("‰", "permille", Quantity("0.001", unitless), alt_names=["per_mille"], canon_symbol=True)
permyriad = DerivedUnit("‱", "permyriad", Quantity("0.0001", unitless), alt_names=["per_myriad"], canon_symbol=True)
percentmille = DerivedUnit(None, "percentmille", Quantity("0.0001", unitless), alt_names=["per_cent_mille"], canon_symbol=False)
